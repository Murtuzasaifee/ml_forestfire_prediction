...
# Input fields
temperature = st.number_input("Temperature", min_value=0.0, max_value=50.0, value=25.0, step=0.1)
rh = st.number_input("Relative Humidity (RH)", min_value=0, max_value=100, value=50, step=1)
ws = st.number_input("Wind Speed (Ws)", min_value=0.0, max_value=50.0, value=5.0, step=0.1)
...
dmc = st.number_input("Duff Moisture Code (DMC)", min_value=0.0, max_value=100.0, value=10.0, step=0.1)
